...
m4_define([graphviz_version_major],[8])
m4_define([graphviz_version_minor],[0])
m4_define([graphviz_version_micro],[3])

m4_define([graphviz_version_date],[20230416.2022])
m4_define([graphviz_change_date],["Sun Apr 16 2023"])
